...
import com.s3reportlambda.DtoLambda.DownloadRequest;
import com.s3reportlambda.DtoLambda.DownloadResponse;
import com.s3reportlambda.S3method.IuseCaseS3Methods;
import com.s3reportlambda.S3method.impl.ImplUseCaseS3Method;

public class DownLoadLambda implements RequestStreamHandler {
  private static final ObjectMapper objectMapper = new ObjectMapper();
  private IuseCaseS3Methods iuseCaseS3Methods;

  public DownLoadLambda() {
  ...
  public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
    ...
    try {
      ...
      DownloadRequest request = objectMapper.readValue(event.getBody(), DownloadRequest.class);

      // Llamar al caso de uso para descargar el archivo
      byte[] fileBytes = this.iuseCaseS3Methods.downloadFile(
      ...
      // Crear respuesta DTO
      DownloadResponse responseBody = new DownloadResponse(request.getKey(), base64file);
