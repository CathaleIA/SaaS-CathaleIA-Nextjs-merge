...
import { createAuthenticatorMachine, getServiceContextFacade, getSendEventAliases, translate, configureComponent, listenToAuthHub, defaultAuthHubHandler, hasTranslation, getFormDataFromEvent, getActorContext, FederatedIdentityProviders, countryDialCodes, getErrors, getTotpCodeURL, defaultFormFieldOptions, getActorState, getSortedFormFields, getDefaultFormFields, applyDefaults, sortFormFields } from '@aws-amplify/ui';
...
function VerifyUserComponent_div_5_Template(rf, ctx) { if (rf & 1) {
    ...
    const unverifiedContactMethod_r2 = ctx.$implicit;
    const ctx_r0 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("value", unverifiedContactMethod_r2.key)("id", ctx_r0.labelId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("for", ctx_r0.labelId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r0.getLabelForAttr(unverifiedContactMethod_r2.key));
} }
...
function ErrorComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("aria-label", ctx_r0.dismissAriaLabel);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("aria-hidden", true);
} }
...
VerifyUserComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: VerifyUserComponent, selectors: [["amplify-verify-user"]], hostVars: 1, hostBindings: function VerifyUserComponent_HostBindings(rf, ctx) { if (rf & 2) {
        ...
        ɵngcc0.ɵɵtextInterpolate(ctx.headerText);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngForOf", ɵngcc0.ɵɵpipeBind1(6, 9, ctx.unverifiedContactMethods));
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("isDisabled", ctx.authenticator.isPending);
        ɵngcc0.ɵɵadvance(1);
...
PhoneNumberFieldComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: PhoneNumberFieldComponent, selectors: [["amplify-phone-number-field"]], hostVars: 2, hostBindings: function PhoneNumberFieldComponent_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵstyleProp("display", ctx.display);
    } }, inputs: { autocomplete: "autocomplete", disabled: "disabled", selectFieldId: "selectFieldId", textFieldId: "textFieldId", initialValue: "initialValue", label: "label", placeholder: "placeholder", required: "required", labelHidden: "labelHidden", defaultCountryCode: "defaultCountryCode", name: "name", type: "type", dialCodeList: "dialCodeList", hasError: "hasError", describedBy: "describedBy" }, decls: 7, vars: 17, consts: [[1, "amplify-label", 3, "for"], ["amplify-field-group", "", 1, "amplify-flex", "amplify-phonenumberfield", 2, "gap", "0px"], [1, "amplify-field-group__outer-start"], [1, "amplify-flex", "amplify-field", "amplify-selectfield", "amplify-countrycodeselect", "amplify-dialcodeselect", 2, "flex-direction", "column"], ["name", "country_code", "label", "Country Code", 3, "id", "items", "defaultValue"], [1, "amplify-input", 3, "id", "type", "name", "placeholder", "required", "value", "autocomplete"]], template: function PhoneNumberFieldComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "label", 0);
        ɵngcc0.ɵɵtext(1);
        ɵngcc0.ɵɵelementEnd();
